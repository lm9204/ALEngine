...
{
	m_shaderResourceManager =
		ShaderResourceManager::createShaderResourceManager(scene, m_descriptorSetLayout->getDescriptorSetLayout());
...
void Renderer::drawFrame(Scene *scene)
{
	...
	recordCommandBuffer(scene, commandBuffers[currentFrame],
	...
	*/
	...
	for (size_t i = 0; i < objectCount; i++)
	{
		vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, pipelineLayout, 0, 1,
								&descriptorSets[MAX_FRAMES_IN_FLIGHT * i + currentFrame], 0, nullptr);
